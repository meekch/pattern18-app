...
export const config = {
  matcher: ['/((?!_next/static|_next/image|favicon\\.ico|login|subscribe|pricing|auth|api|resources|getting-started|icon|manifest|thank-you|demo|dashboard|faq|opengraph-image|twitter-image|founding).*)'],
}
