...
export default function UploadPage() {
  ...
  return (
    <div style={{minHeight:"100vh",background:"#f8faf9"}}>
      <header style={{background:"linear-gradient(135deg,#1F2937,#1A5F5A)",padding:"16px 24px",display:"flex",justifyContent:"space-between",alignItems:"center",color:"white"}}>
